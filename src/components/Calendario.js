...
export default function Calendario() {
    ...
    clientesSnapshot.docs.forEach((doc) => {
      ...
      const citasData = citasSnapshot.docs.map((doc) => {
        ...
        return {
            ...
            telefono: cliente.telefono, // Número de WhatsApp
            estado: data.estado,
            notas: data.notas,
            precio: data.precio,
          };
  ...
  const handleActualizar = (citaActualizada) => {
    ...
    setIsEditing(false); // Vuelve a la vista de detalles
    setModalData(citaActualizada); // Actualiza los datos mostrados
  };
          ...
          <Modal.Body>
            {isEditing ? (
              ...
              <>
                ...
                <p>
                  <strong>Servicio:</strong> {modalData.title}
                </p>
                <p>
